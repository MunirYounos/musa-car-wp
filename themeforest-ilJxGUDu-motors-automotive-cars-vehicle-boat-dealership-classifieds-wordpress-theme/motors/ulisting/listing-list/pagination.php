 ...
 * @version 1.5.5
 */
wp_enqueue_script('stm-listing-pagination', get_template_directory_uri() . '/assets/js/ulisting/frontend/stm-listing-pagination.js', array('vue'), ULISTING_VERSION, true);
