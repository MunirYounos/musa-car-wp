...
if (!stm_is_boats()) {
    if (stm_is_motorcycle() or stm_is_rental() || stm_is_magazine() || is_listing(array('listing_two', 'listing_three', 'listing_five')) || stm_is_equipment()) {
        ...
        STM_Customizer::setSection( 'user_dealer', array(
            ...
            'fields' => array(
                ...
                'dealer_payments_for_featured_listing' => array(
                    'label' => esc_html__( 'Enable Payed Featured Listing', 'motors' ),
                    'type' => 'stm-checkbox',
                    'default' => false
                ),
