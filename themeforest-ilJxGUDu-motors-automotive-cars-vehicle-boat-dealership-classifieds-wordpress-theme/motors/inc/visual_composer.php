...
function stm_update_existing_shortcodes()
{
    ...
    if (function_exists('vc_add_params')) {
        ...
        vc_add_params('vc_row', array(
			...
			array(
				'type' => 'textfield',
				'heading' => __('Float menu item title', 'motors'),
				'param_name' => 'float_menu_item_title'
			),
			array(
				'type' => 'textfield',
				'heading' => __('Float menu color', 'motors'),
				'param_name' => 'float_menu_color'
			),
			array(
				'type' => 'textfield',
				'heading' => __('Anchor for float menu', 'motors'),
        ...
        vc_add_param('vc_single_image', array(
            'type' => 'checkbox',
            'heading' => __('Enable STM theme LightGallery on click', 'motors'),
...
function vc_stm_elements()
{
    ...
    if (!is_wp_error($bodyCats) && !empty($bodyCats)) {
        foreach ($bodyCats as $cat) {
            $bodyItems[$cat->name . ' (' . $cat->count . ')'] = $cat->slug;
        }
    }
	...
	vc_map(array(
		...
		'category' => __('STM General', 'motors'),
		'params' => array(
			array(
				'type' => 'textfield',
    ...
    vc_map(array(
        ...
        'params' => array(
            array(
                'type' => 'checkbox',
                'heading' => __('Show Subtitle', 'motors'),
                'param_name' => 'show_sub_title',
                'description' => esc_html__('Enable subtitle. (Note: displays only subtitle text)', 'motors'),
                'value' => array(
                    __('Yes', 'motors') => 'yes',
                ),
                'std' => ''
            ...
            array(
                ...
                'param_name' => 'subtitle',
                'holder' => 'div',
                'dependency' => array('element' => 'show_sub_title', 'value' => 'yes'),
            ),
            array(
                'type' => 'textfield',
    ...
    vc_map(array(
        ...
        'base' => 'stm_gmap',
        'icon' => 'stm_gmap',
        'category' => esc_html__('STM General', 'motors'),
        'params' => array(
            array(
                'type' => 'textfield',
	...
	vc_map(array(
		...
		'params' => array(
			...
			array(
				'type' => 'checkbox',
				'heading' => __('Use counter for title', 'motors'),
    ...
    if(!defined('STM_MOTORS_CLASSIFIED_SIX') && !defined('STM_MOTORS_CAR_RENTAL')) {
		//Spec offers
		vc_map(array(
		...
		if (stm_is_motorcycle()) {
			...
			$classic_filter_args = array(
				array(
					'type' => 'textfield',
					'heading' => __('Posts per page on list view', 'motors'),
					'param_name' => 'ppp_on_list',
					'value' => '10'
				),
				array(
					'type' => 'textfield',
					'heading' => __('Posts per page on grid view', 'motors'),
					'param_name' => 'ppp_on_grid',
					'value' => '9'
				),
				array(
					'type' => 'dropdown',
					'heading' => __('Quantity of listing per row on grid view', 'motors'),
		...
		vc_map(array(
			'name' => __('STM Popular Searches', 'motors'),
		...
		vc_map(array(
			'name' => __('STM Popular Search', 'motors'),
		...
		if(stm_is_mm_active() && function_exists('stm_get_taxonomies')) {

			vc_map(
				array(
					'name' => __( 'STM MegaMenu Top Categories', 'motors' ),
					'base' => 'stm_mm_top_categories',
					'category' => __( 'STM MegaMenu', 'motors' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'holder' => 'div',
					...
					array(
						'type' => 'dropdown',
						'heading' => __( 'Select Listing Category', 'motors' ),
						'param_name' => 'main_category',
						'value' => stm_get_taxonomies(),
						),
					array(
						'type' => 'stm_mm_top_terms_vc',
						'heading' => __( 'Select Listing Category Taxonomies', 'motors' ),
			...
			vc_map(
				array(
					'name' => __( 'STM MegaMenu Top Vehicles', 'motors' ),
			...
			$topVehicles = stm_mm_get_top_vehicles();

			vc_map(
				array(
					'name' => __( 'STM MegaMenu Top Makes Tabs', 'motors' ),
					...
					'params' => array(
						...
						array(
							'type' => 'checkbox',
							'heading' => __( 'Check makes for tabs', 'motors' ),
							'param_name' => 'top_makes', 'value' => $topVehicles,
							),
						array(
							'type' => 'css_editor',
							'heading' => __( 'Css', 'motors' ),
		...
		if (!stm_is_motorcycle()) {
			if (!stm_is_boats()) {
				...
				vc_map(array(
					'name' => __('STM Image Filter By Body Type', 'motors'),
					...
					'params' => array(
						...
						array(
							'type' => 'dropdown',
							'heading' => __('Items Per Row', 'motors'),
							'param_name' => 'row_number',
							'value' => array(
								'3' => '3',
								'4' => '4',
						...
						array(
							...
							'params' => array(
								...
								array(
									'type' => 'checkbox',
									'heading' => __('Set Body Type', 'motors'),
				...
				vc_map(array(
					...
					'params' => array(
						...
						array(
							'type' => 'checkbox',
							'heading' => __('Show Advertisement', 'motors'),
						...
						array(
							'type' => 'textfield',
							'heading' => __('Advertisement Link', 'motors'),
							'param_name' => 'advert_link',
							'dependency' => array('element' => 'show_advert', 'value' => 'yes'),
						),
						array(
							'type' => 'attach_image',
							'heading' => __('Advertisement image', 'motors'),
				...
				if(!stm_is_magazine()) {
					vc_map(array(
						...
						'params' => array(
							...
							array(
								'type' => 'colorpicker',
								'heading' => __('Inactive Tab BG Color', 'motors'),
							...
							array(
								'type' => 'colorpicker',
								'heading' => __('Active Tab BG Color', 'motors'),
				...
				if (function_exists('stm_review_archive_link')) {
					vc_map(array(
						'name' => __('STM Listing Two Search (tabs)', 'motors'),
						...
						'params' => array(
							...
							array(
								'type' => 'textfield',
								'heading' => __('First Tab Label', 'motors'),
								'param_name' => 'first_tab_label',
								'std' => __('Find a car', 'motors'),
							),
							array(
								'type' => 'textfield',
								'heading' => __('Second Tab Label', 'motors'),
								'param_name' => 'second_tab_label',
								'std' => __('Car reviews', 'motors'),
							),
							array(
								'type' => 'textfield',
								'heading' => __('Third Tab Label', 'motors'),
								'param_name' => 'third_tab_label',
								'std' => __('Value my car', 'motors'),
							),
							array(
								'type' => 'textfield',
								'heading' => __('Search button postfix', 'motors'),
							...
							array(
								'type' => 'checkbox',
								'heading' => __('Select Taxonomies, which will be in first tab as filter', 'motors'),
								'param_name' => 'first_tab_tax',
								'value' => $stm_filter_options_location,
							),
							array(
								'type' => 'checkbox',
								'heading' => __('Select Taxonomies, which will be in second tab as filter', 'motors'),
								'param_name' => 'second_tab_tax',
								'value' => $stm_filter_options_location,
							),
							array(
								'type' => 'checkbox',
								'heading' => __('Select Taxonomies, for Value My Car', 'motors'),
				...
				vc_map(array(
					'name' => __('STM Car Seller Note', 'motors'),
					...
					$stm_pt_params[] = array(
						...
						'params' => array(
							array(
								...
								'value' => array(
									esc_html__('Month', 'motors') => 'month',
									esc_html__('Yearly', 'motors') => 'yearly'
								),
								'admin_label' => true,
							),
							array(
		...
		vc_map(array(
			'name' => __('STM Inventory No Filter', 'motors'),
			'base' => 'stm_inventory_no_filter',
			'category' => __('STM Listing Layout', 'motors'),
			'params' => array(
				array(
					'type' => 'dropdown',
					'heading' => __('Order By', 'motors'),
					'param_name' => 'order_by',
					'value' => array(
						'DESC' => 'desc',
						'ASC' => 'asc'
				...
				array(
					'type' => 'textfield',
					'heading' => __('Posts Per Page', 'motors'),
					'param_name' => 'posts_per_page',
					'std' => 4
				),
				array(
		...
		$stm_main_filter_options_location = $stm_filter_options;

		vc_map(array(
			'name' => __('STM Inventory With Filter', 'motors'),
			...
			'params' => array(
				...
				array(
					'type' => 'dropdown',
					'heading' => __('Navigation', 'motors'),
					'param_name' => 'navigation',
					'value' => array(
						__('Pagination', 'motors') => 'pagination',
						__('Load More Button', 'motors') => 'load_more',
					),
					'std' => 'load_more'
				),
				array(
					...
					'heading' => __('Select Taxonomies, which will be in this tab as filter', 'motors'),
					'param_name' => 'filter_all',
					'value' => $stm_main_filter_options_location,
					'dependency' => array('element' => 'show_all', 'value' => 'yes'),
				),
				array(
					'type' => 'css_editor',
		...
		vc_map(array(
			'name' => __('STM Category Info Box', 'motors'),
			'base' => 'stm_category_info_box',
			'category' => __('STM', 'motors'),
			'params' => array(
				array(
					'type' => 'dropdown',
					'heading' => __('Select Taxonomy', 'motors'),
					'param_name' => 'cat_slug',
		...
		vc_map(array(
			"name" => esc_html__('Stm Cars On Top', 'motors'),
			...
			"params" => array(
				...
				array(
					'type' => 'textfield',
					'heading' => esc_html__('Numbers of Cars', 'motors'),
		...
		vc_map(array(
			"name" => esc_html__('Stm Reduced Cars', 'motors'),
		...
		vc_map(array(
			"name" => esc_html__('Stm Info Block Animate', 'motors'),
		...
		vc_map(array(
				'name' => esc_html__('Stm Listing Map by My Location', 'motors'),
				...
				'params' => array(
					array(
						...
						'heading' => esc_html__('Address', 'motors'),
						'param_name' => 'address'
					),
					array(
						'type' => 'textfield',
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Search Radius', 'motors'),
					...
					array(
						'type' => 'attach_image',
						'heading' => __('Marker Image', 'motors'),
						'param_name' => 'marker'
					),
					array(
						'type' => 'attach_image',
						'heading' => __('Cluster Image (60x60)', 'motors'),
						'param_name' => 'cluster'
					),
					array(
						'type' => 'css_editor',
		...
		vc_map(array(
			'name' => __('STM Listing Categories Grid', 'motors'),
		...
		if (stm_is_aircrafts()) {
			vc_map(array(
				'name' => __('STM Aircraft Data Table', 'motors'),
				'base' => 'stm_aircraft_data_table',
				'icon' => 'stm_aircraft_data_table',
				'category' => __('STM Aircraft', 'motors'),
				'params' => array(
					array(
						'type' => 'textfield',
						'heading' => __('Title', 'motors'),
					...
					array(
						'type' => 'checkbox',
						'heading' => __('Select Taxonomies', 'motors'),
	...
	}//!defined('STM_MOTORS_CLASSIFIED_SIX') && !defined('STM_MOTORS_CAR_RENTAL')
}
...
if (class_exists('WPBakeryShortCode')) {
    ...
    if(stm_is_mm_active()) {
		class WPBakeryShortCode_Stm_MM_Top_Categories extends WPBakeryShortCode
		{
		}
		class WPBakeryShortCode_Stm_MM_Top_Vehicles extends WPBakeryShortCode
		{
		}
		class WPBakeryShortCode_Stm_MM_Top_Makes_Tab extends WPBakeryShortCode
		{
		}
	}
    ...
    class WPBakeryShortCode_STM_Popular_Search extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Image_Filter_By_Type extends WPBakeryShortCode
    {
    }
    ...
    class WPBakeryShortCode_STM_Listing_Categories_Grid extends WPBakeryShortCode
    {
    }
    ...
    if (stm_is_aircrafts()) {
        class WPBakeryShortCode_STM_Aircraft_Data_Table extends WPBakeryShortCode
        {
        }
    }
    ...
    if (!stm_is_motorcycle()) {
        if (!stm_is_boats()) {
            ...
            class WPBakeryShortCode_Stm_Listing_Two_Search extends WPBakeryShortCode
            {
            }
            ...
            class WPBakeryShortCode_Stm_Car_Seller_Note extends WPBakeryShortCode
            {
            }
    ...
    class WPBakeryShortCode_STM_Inventory_No_Filter extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Inventory_With_Filter extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Category_Info_Box extends WPBakeryShortCode
    {
    }
    ...
    class WPBakeryShortCode_STM_Cars_On_Top extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Reduced_Cars extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Info_Block_Animate extends WPBakeryShortCode
    {
    }

    class WPBakeryShortCode_STM_Listing_Map_By_My_Location extends WPBakeryShortCode
    {
    }
}
