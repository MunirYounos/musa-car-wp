...
function getDefaultSubject($templateName) {
	...
	$user_listing_wait = 'Add a car';

	$user_listing_approved = 'Car Approved';
...
function updateTemplates () {
    $opt = array ('add_a_car_', 'user_listing_wait_', 'user_listing_approved_', 'update_a_car_ppl_', 'trade_in_', 'trade_offer_', 'request_price_', 'test_drive_', 'update_a_car_', 'report_review_', 'password_recovery_', 'request_for_a_dealer_', 'welcome_', 'new_user_', 'pay_per_listing_', 'value_my_car_');
