...
$uniqClass = 'stm-car-videos-' . rand(1, 10000);
?>
...
<div class="image">
    ...
    <div class="stm-car-medias">
        ...
        <?php if(!empty($car_media['car_videos_count'])): ?>
            <div class="stm-listing-videos-unit stm-car-videos-<?php echo get_the_id(); ?> <?php echo esc_attr($uniqClass); ?>">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function(){
                    jQuery(".<?php echo esc_attr($uniqClass); ?>").on('click', function() {
                        jQuery(this).lightGallery({
                            dynamic: true,
                            dynamicEl: [
